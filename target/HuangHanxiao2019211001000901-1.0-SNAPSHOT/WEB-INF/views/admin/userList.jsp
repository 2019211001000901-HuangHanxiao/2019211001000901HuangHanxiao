		...
		<h2 class="title text-center">User <strong>List</strong></h2> 
				<table class="table table-condensed">
					...
					<sql:setDataSource var="myDS"
									   ...
									   url="jdbc:sqlserver://localhost:1433;databaseName=userHHx"
									   user="sa"
					...
					<c:forEach var="row" items="${allUser.rows}">
						<tr>
							...
							<td class="cart_delete">
							   <a class="cart_quantity_update" href="<%=basePath %>admin/userEdit?userId=${roe.id}" ><i class="fa fa-edit"></i></a>
								<a class="cart_quantity_delete" href="<%=basePath%>admin/userDelete?userId=${roe.id}" ><i class="fa fa-times"></i></a>
							</td>
						</tr>
						</c:forEach>
						<!-- loop_end -->
