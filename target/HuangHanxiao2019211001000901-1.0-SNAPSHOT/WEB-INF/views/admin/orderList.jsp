			...
			<div class="table-responsive col-sm-10">
				...
				<thead>
					...
					<tr>
						...
						<td>${o.orderDate}</td>
						<%
							com.HuangHanxiao.model.Order o=(com.HuangHanxiao.model.Order)pageContext.findAttribute("o");
							int userId=o.getCustomerId();
							java.sql.Connection con=(java.sql.Connection)application.getAttribute("con");
							com.HuangHanxiao.dao.UserDao userDao=new com.HuangHanxiao.dao.UserDao();
